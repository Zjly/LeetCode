...
public class Question1319_NumberOfOperationsToMakeNetworkConnected {
...
class Solution1319 {
	public int makeConnected(int n, int[][] connections) {
		...
		for(int[] connection : connections) {
			surplus += union(unionSet, connection[0], connection[1]);
		}
		...
		return unionCount <= surplus ? unionCount : -1;
	}
	...
	public int union(int[] unionSet, int index1, int index2) {
