...
/**
 * @author ZhangLei
 * @version 2026/03/10 00:21
 */
public class Question3130_找出所有稳定的二进制数组II {
    ...
    @Test
    public void test2() {
        Assertions.assertEquals(1, numberOfStableArrays(1, 2, 1));
    }

    @Test
    public void test3() {
        Assertions.assertEquals(14, numberOfStableArrays(3, 3, 2));
    }
}
