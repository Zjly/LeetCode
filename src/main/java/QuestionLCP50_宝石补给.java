...
public class QuestionLCP50_宝石补给 {
	SolutionLCP50 solutionLCP50 = new SolutionLCP50();

	@Test
	public void test() {
		int[] gem = {0, 2, 5, 4};
		int[][] operations = {{3, 2}, {3, 2}, {1, 3}, {0, 2}, {3, 0}, {3, 1}, {0, 3}, {2, 1}, {3, 0}};
		Assertions.assertEquals(4, solutionLCP50.giveGem(gem, operations));
	}
}
...
class SolutionLCP50 {
	public int giveGem(int[] gem, int[][] operations) {
		...
		for(int g : gem) {
			maxGem = Math.max(maxGem, g);
			minGem = Math.min(minGem, g);
		}
