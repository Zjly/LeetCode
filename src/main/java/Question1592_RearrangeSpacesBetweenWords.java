...
public class Question1592_RearrangeSpacesBetweenWords {
	public static void main(String[] args) {
		Solution1592 solution1592 = new Solution1592();
		String text = "a";
		System.out.println(solution1592.reorderSpaces(text));
	}
}
...
class Solution1592 {
	public String reorderSpaces(String text) {
		...
		int num = count / (arrayList.size() - 1);
		StringBuilder stringBuilder = new StringBuilder();
		...
		for(int i = 0; i < count % (arrayList.size() - 1); i++) {
			stringBuilder.append(" ");
		}
